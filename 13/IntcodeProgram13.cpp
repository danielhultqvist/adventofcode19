...
void IntcodeProgram13::run(const vector<long long> &inputValues) {
...
long long IntcodeProgram13::getParameter(int mode, int offset) {
  switch (mode) {
    case 0:
...
void IntcodeProgram13::multiply() {
  int firstMode = (memory[pointer] / 100) % 10;
  int secondMode = (memory[pointer] / 1000) % 10;
  int thirdMode = (memory[pointer] / 10000) % 10;
...
void IntcodeProgram13::jumpIfFalse() {
  int firstMode = (memory[pointer] / 100) % 10;
  int secondMode = (memory[pointer] / 1000) % 10;
...
void IntcodeProgram13::lessThan() {
  int firstMode = (memory[pointer] / 100) % 10;
  int secondMode = (memory[pointer] / 1000) % 10;
  int thirdMode = (memory[pointer] / 10000) % 10;
...
void IntcodeProgram13::adjustBase() {
  int mode = (memory[pointer] / 100) % 10;
...
std::vector<long long> IntcodeProgram13::getOutputAndReset() {
